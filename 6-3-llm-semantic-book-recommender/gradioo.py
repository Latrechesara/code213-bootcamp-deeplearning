...
db_books=Chroma.from_documents(documents,embeddings=HuggingFaceEmbeddings(model_name="sentence-transformers/all-MiniLM-L6-v2"))
...
def recommend_books(
    ...
    for _,row in recommendations.iterrows():
        ...
        results.append((row['large_thumbail'],caption))
    return results
...
with gr.Blocks(theme =gr.theme.Glass())  as dashboard:
    ...
    with gr.Row():
        user_query=gr.Text.box(label="Enter a book description ",
                               placeholder="e.g., A story about forgiveness")
        category_dropdown= gr.Dropdow(choices=categories,value="All", label="Select a category: ", value="All")
        tone_dropdown=gr.Dropdown(choices=tones,value="All",label="Select an emotional tone: ",value="All")
